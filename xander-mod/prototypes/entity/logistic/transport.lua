	...
	{
		{
			...
			"__xander-v1-graphics__/graphics/entity/logistic/cargo-wagon-2/%1%2",
		},
		{
			"__base__/graphics/entity/cargo-wagon/(h?r?-?)cargo-wagon-door-",
			"__xander-v1-graphics__/graphics/entity/logistic/cargo-wagon-2/%1door-",
		},
	},
	{
		name = "cargo-wagon-2",
	...
	{
			{
				...
				"__xander-v1-graphics__/graphics/entity/logistic/fluid-wagon-2/%1%2",
			},
			{
				"__base__/graphics/entity/fluid-wagon/(h?r?-?)fluid-wagon-door-",
				"__xander-v1-graphics__/graphics/entity/logistic/fluid-wagon-2/%1door-",
			},
	},
	{
		name = "fluid-wagon-2",
